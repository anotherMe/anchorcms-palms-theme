...
<html lang="en">
    ...
    <body class="<?php echo body_class(); ?>">
        ...
        <div class="main-wrap">
            ...
            <div class="slidey" id="tray">
                <div class="wrap">
                    <form id="search" action="<?php echo search_url(); ?>" method="post">
                        <label for="term">Search categories:</label>
            ...
            <div class="slidey" id="tag_tray">
                
                <div class="wrap">
                    <form id="tagsearch" action="<?php echo base_url('posts'); ?>" method="get">
                        <label for="tag">Search tags:</label>
                        <input type="search" id="tag" name="tag" placeholder="To search, type and hit enter&hellip;" value="">
                    </form>
                </div>
